...
- [ ] Stworzyć i użyć komponent `Input` aby zapobiec powtarzaniu się w kodzie
- [ ] W komponencie `Input` użyć propsa `...other` oraz ustawić domyślną wartość dla propsa `type`
